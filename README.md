# Docker Image for Build Android [![](https://images.microbadger.com/badges/image/quirijngb/gitlab-ci-android.svg)](https://microbadger.com/images/quirijngb/gitlab-ci-android "Get your own image badge on microbadger.com")

GitLab CI image for building and testing Android apps

This code on repo will automatically build on Docker Hub : 

https://hub.docker.com/r/quirijngb/gitlab-ci-android/

## Example `.gitlab-ci.yml` file
```yml
image:  quirijngb/gitlab-ci-android:latest
